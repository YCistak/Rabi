...
export function Onay({
  ...
  if (!acik) return null
  return (
    <div className="katman-zemin fixed inset-0 z-50 flex items-end justify-center bg-black/40 px-4 pt-[calc(1rem+var(--guvenli-ust))] pb-[calc(1rem+var(--guvenli-alt))]">
