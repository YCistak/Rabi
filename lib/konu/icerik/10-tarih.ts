  ...
  tema('trh10-t1', 'Türkistan’dan Türkiye’ye (1040-1299)', [
    konu('trh10-mucadele', 'Türkistan’dan Türkiye’ye Askerî Mücadeleler', [
      ...
      kart(
        ...
        { not: 'Savaşları tarihiyle değil sonucuyla sırala: kapı açıldı, umut bitti, otorite çöktü.' },
      ),
      kart(
        'Miryokefalon (1176)',
    ...
    konu('trh10-teskilat', 'Türk Devlet ve Ordu Teşkilatındaki Değişim', [
      ...
      kart(
        ...
        undefined,
        { not: 'Tek düzenlemenin üç işi; sınav "ikta neyi sağladı" derken üçünü birden ister.' },
      ),
      kart(
        'Ordu unsurları',
    ...
    konu('trh10-sosyal', 'Türklerin Sosyal Yaşamları ve Ekonomik Faaliyetleri', [
      ...
      kart(
        ...
        undefined,
        { not: 'Vakfı hayır işi olarak değil, sürekli gelir bağlanmış bir hizmet olarak oku.' },
      ),
      kart(
    ...
    konu('trh10-turk-islam', 'Türk-İslam Medeniyetinde Bilim, Kültür ve Sanat', [
      ...
      kart(
        ...
        undefined,
        { not: 'Yayılmanın sebebi öğretinin içeriği kadar dili ve tavrı; ikisini birlikte tut.' },
      ),
      kart(
        'Mimari',
  ...
  tema('trh10-t2', 'Beylikten Devlete Osmanlı (1299-1453)', [
    konu('trh10-kurulus', 'Osmanlı Devleti’nin Kuruluşuna Dair Görüşler', [
      ...
      kart(
        ...
        { not: '"Hangisi doğru" diye sorma; her görüş sürecin başka bir yanını görüyor.' },
      ),
      kart(
        'Coğrafi konum',
    ...
    konu('trh10-anadolu-rumeli', 'Anadolu ve Rumeli’deki Siyasi ve Askerî Mücadeleler', [
      ...
      kart(
        ...
        undefined,
        { not: 'Fetret\'te Anadolu dağıldı, Balkanlar kaldı; sebebi bir politikanın adı: istimalet.' },
      ),
      kart(
    ...
    konu('trh10-devletlesme', 'Devletleşme Süreci: Ordu, Hukuk ve Toprak', [
      ...
      kart(
        ...
        undefined,
        { not: 'Tımar, ordu, hukuk: üçünü ayrı başlık değil tek bir çark gibi düşün.' },
      ),
    ], [
    ...
    konu('trh10-kalicilik', 'Fethettiği Topraklarda Kalıcı Olma Politikaları', [
      ...
      kart(
        ...
        undefined,
        { not: 'Politikaları ezberleme; köylünün gözünden bak, neden direnmediğini anla.' },
      ),
    ], [
    ...
    konu('trh10-ilim-irfan', 'İlim ve İrfan Geleneğinin Oluşması', [
      ...
      kart(
        ...
        undefined,
        { not: 'Külliye bir bina değil, tek vakıfla dönen bir şehir merkezi.' },
      ),
      kart(
        'Öne çıkan adlar',
  ...
  tema('trh10-t3', 'Cihan Devleti Osmanlı (1453-1683)', [
    konu('trh10-siyasi', '1453-1683 Arasındaki Siyasi ve Askerî Mücadeleler', [
      ...
      kart(
        ...
        { not: 'Tarihleri değil kırılmaları tut: zirve, ilk büyük yenilgi, geri çekilişin başı.' },
      ),
      kart(
        'En geniş sınırlar',
    ...
    konu('trh10-yonetim-degisim', 'Yönetim ve Ordu Yapısındaki Değişim', [
      ...
      kart(
        ...
        undefined,
        { not: 'Islahatları isimleriyle değil hedefiyle oku: eskiyi onarmak mı, yeniyi kurmak mı?' },
      ),
    ], [
    ...
    konu('trh10-somurge', 'Avrupa’nın Sömürgeci Politikalarının Etkileri', [
      ...
      kart(
        ...
        { not: 'Gümüş bolluğu zenginlik değil; para değer kaybedince kim kazandı, kim kaybetti sor.' },
      ),
      kart(
        'Kapitülasyonlar',
    ...
    konu('trh10-isyan', 'Önemli İsyanların Neden ve Sonuçları', [
      ...
      kart(
        ...
        { not: 'Üç isyanın yerini ayır, sebebini birleştir: hepsinin altında aynı mali çöküş.' },
      ),
      kart(
        'Ortak sebep',
    ...
    konu('trh10-bilim-kultur', '1453-1683 Arasında Bilim, Kültür ve Sanat', [
      ...
      kart(
        ...
        undefined,
        { not: 'Eserleri listelemek yetmez; bilginin çoğaltılma hızındaki farkı da gör.' },
      ),
    ], [
