...
export const tarih10 = program('tarih', 10, 'Türkistan’dan cihan devletine', [
  ...
  tema('trh10-t2', 'Beylikten Devlete Osmanlı (1299-1453)', [
    ...
    konu('trh10-ilim-irfan', 'İlim ve İrfan Geleneğinin Oluşması', [
      ...
      kart(
        'Enderun',
        'Sarayda devşirmeler arasından seçilenlerin eğitildiği okuldur.\nDil, din, sanat ve devlet işleri öğretilir; mezunlar yüksek görevlere gelirdi.',
      ),
      kart(
        'Şeyhülislamlık',
        'Dinî konularda fetva veren en yüksek makamdır.\nİlk şeyhülislam Molla Fenari’dir; zamanla ilmiye sınıfının başı oldu.',
      ),
      kart(
        'İlmiye sınıfı',
        'Medreselerde yetişen kadı, müderris ve müftülerden oluşurdu.\nHukuk, eğitim ve din hizmetlerini yürütürlerdi.',
      ),
      kart(
        'Ali Kuşçu İstanbul’da',
        'Semerkant’tan Fatih’in davetiyle İstanbul’a geldi.\nAyasofya Medresesi’nde matematik ve astronomi okuttu.',
      ),
    ], [
      ...
      soru('Enderun saray okuludur.', true, 'Devşirmeler arasından seçilenler eğitilirdi.'),
      soru('İlk şeyhülislam Davud-i Kayseri\'dir.', false, 'İlk şeyhülislam Molla Fenari; Davud-i Kayseri ilk başmüderris.'),
      soru('Kadılar ilmiye sınıfındandır.', true, 'Medreselerde yetişirlerdi.'),
      sikli('Ali Kuşçu İstanbul\'a kimin davetiyle geldi?', ['Kanuni', 'Fatih'], 1, 'Semerkant\'tan geldi.'),
      sikli('Fetva veren en yüksek makam?', ['Şeyhülislam', 'Kazasker'], 0, 'Kazasker yargı ve eğitimle ilgilenir.'),
    ], [
      {
  ...
  tema('trh10-t3', 'Cihan Devleti Osmanlı (1453-1683)', [
    konu('trh10-siyasi', '1453-1683 Arasındaki Siyasi ve Askerî Mücadeleler', [
      ...
      kart(
        'Otlukbeli (1473)',
        'Fatih, Akkoyunlu hükümdarı Uzun Hasan’ı yendi.\nDoğu Anadolu’da Osmanlı üstünlüğü kuruldu.',
      ),
      kart(
        'Mercidabık (1516)',
        'Yavuz, Memlükleri Suriye’de yendi; Ridaniye (1517) ile Mısır da alındı.\nKutsal şehirler ve Doğu Akdeniz ticareti Osmanlı’ya geçti.',
      ),
      kart(
        'Kıbrıs (1571)',
        'II. Selim döneminde alındı.\nDoğu Akdeniz ticaret yolunun güvenliği sağlandı.',
      ),
      kart(
        'Zitvatorok (1606)',
        'Avusturya ile yapıldı; Avusturya arşidükü Osmanlı padişahıyla eşit sayıldı.\nOsmanlı’nın Batı karşısındaki üstünlüğünün sarsıldığının işaretidir.',
      ),
      kart(
        'Kasr-ı Şirin (1639)',
        'IV. Murat döneminde İran ile imzalandı.\nBelirlenen sınır bugünkü Türkiye-İran sınırına büyük ölçüde yakındır.',
      ),
    ], [
      ...
      soru('Otlukbeli Savaşı Akkoyunlulara karşı kazanıldı.', true, 'Uzun Hasan yenildi.'),
      soru('Kıbrıs Kanuni döneminde alındı.', false, 'II. Selim döneminde, 1571.'),
      soru('Kasr-ı Şirin ile belirlenen sınır bugünkü Türkiye-İran sınırına yakındır.', true, '1639.'),
      sikli('Avusturya arşidükünü padişahla eşit sayan antlaşma?', ['Kasr-ı Şirin', 'Zitvatorok'], 1, 'Kasr-ı Şirin İran\'la.'),
      sikli('Memlükleri Suriye\'de yenen savaş?', ['Mercidabık', 'Otlukbeli'], 0, '1516.'),
    ], [
      {
      ...
      {
        soru: 'Türkiye-İran sınırını büyük ölçüde belirleyen antlaşma?',
        siklar: ['Zitvatorok', 'Kasr-ı Şirin'],
        dogru: 1,
        aciklama: {
          dogru: '1639\'da IV. Murat döneminde İran\'la imzalandı.',
          yanlis: 'Zitvatorok Avusturya ile yapıldı. İran sınırı Kasr-ı Şirin\'le çizildi.',
        },
        kart: 13,
      },
    ]),
    konu('trh10-yonetim-degisim', 'Yönetim ve Ordu Yapısındaki Değişim', [
      ...
      kart(
        'Babıali',
        '17. yüzyıl ortasında sadrazamın konağı devlet işlerinin merkezi oldu.\nDivan-ı Hümayun’un yerini zamanla Babıali aldı.',
      ),
      kart(
        'Köprülü Mehmet Paşa’nın şartları',
        'Sadrazamlığı kabul ederken işlerine karışılmamasını şart koştu (1656).\nOtoriteyi sertlikle toparladı; Köprülüler dönemi başladı.',
      ),
      kart(
        'Malikâne sistemi',
        'İltizamın uzantısıdır: vergi toplama hakkı ömür boyu satıldı (1695).\nHazine kısa vadede para buldu, taşrada ayanlar güçlendi.',
      ),
    ], [
      ...
      soru('Babıali sadrazamın konağıdır.', true, 'Devlet işlerinin merkezi oldu.'),
      soru('Malikâne sisteminde vergi toplama hakkı bir yıllığına verilirdi.', false, 'Ömür boyu verilirdi.'),
      sikli('Köprülü Mehmet Paşa sadrazamlığı hangi şartla kabul etti?', ['İşlerine karışılmaması', 'Ordunun kaldırılması'], 0, '1656.'),
      sikli('Divan-ı Hümayun\'un yerini zamanla alan kurum?', ['Enderun', 'Babıali'], 1, 'Enderun saray okulu.'),
    ], [
      {
      ...
      {
        soru: 'Vergi toplama hakkının ömür boyu satılmasına ne denir?',
        siklar: ['Tımar', 'Malikâne'],
        dogru: 1,
        aciklama: {
          dogru: 'Malikâne, iltizamın ömür boyu uzatılmış biçimidir.',
          yanlis: 'Tımar hizmet karşılığı verilen dirliktir. Ömür boyu vergi hakkı malikâne.',
        },
        kart: 11,
      },
    ]),
    konu('trh10-somurge', 'Avrupa’nın Sömürgeci Politikalarının Etkileri', [
      ...
      kart(
        'Sömürgeci devletler',
        '- **Önce:** İspanya ve Portekiz\n- **Sonra:** İngiltere, Hollanda, Fransa\nDoğu Hindistan şirketleri ticareti devlet desteğiyle yürüttü.',
      ),
      kart(
        'Merkantilizm',
        'Bir ülkenin zenginliğini altın ve gümüş birikimiyle ölçen anlayıştır.\nİhracatı artırıp ithalatı kısmayı hedefler.',
      ),
      kart(
        'Hint Okyanusu seferleri',
        'Osmanlı, Portekizlilerin Kızıldeniz ve Hint ticaretini kesmesine karşı donanma gönderdi.\nHadım Süleyman Paşa’nın Hindistan seferi (1538) bunlardandır.',
      ),
      kart(
        'Amerika’nın yerlileri',
        'Sömürgecilik Amerika’da yerli halkın büyük kısmını savaş ve salgınla yok etti.\nEksilen iş gücü Afrika’dan getirilen kölelerle dolduruldu.',
      ),
    ], [
      soru(
      ...
      soru('Merkantilizm zenginliği altın ve gümüş birikimiyle ölçer.', true, 'İhracat öne çıkar.'),
      soru('Osmanlı Portekizlilere karşı Hint Okyanusu\'na donanma göndermedi.', false, 'Hadım Süleyman Paşa seferi 1538.'),
      soru('Amerika\'da iş gücü açığı Afrika\'dan getirilen kölelerle kapatıldı.', true, 'Atlantik köle ticareti.'),
      sikli('İlk sömürgeci devletler?', ['İngiltere ve Fransa', 'İspanya ve Portekiz'], 1, 'İngiltere ve Fransa sonra geldi.'),
      sikli('Hint seferine çıkan Osmanlı komutanı?', ['Hadım Süleyman Paşa', 'Barbaros'], 0, 'Barbaros Akdeniz\'de.'),
    ], [
      {
      ...
      {
        soru: 'Zenginliği altın ve gümüş birikimiyle ölçen anlayış?',
        siklar: ['Feodalizm', 'Merkantilizm'],
        dogru: 1,
        aciklama: {
          dogru: 'Merkantilizm ihracatı artırıp değerli maden biriktirmeyi hedefler.',
          yanlis: 'Feodalizm toprak ve bağlılık düzenidir. Maden birikimi merkantilizm.',
        },
        kart: 9,
      },
    ]),
    konu('trh10-isyan', 'Önemli İsyanların Neden ve Sonuçları', [
      ...
      kart(
        'Karayazıcı isyanı',
        'Celali isyanlarının en büyüklerindendir (16. yüzyıl sonu).\nKuyucu Murat Paşa isyanları sert yöntemlerle bastırdı.',
      ),
      kart(
        'Genç Osman’ın öldürülmesi',
        'II. Osman yeniçeriyi kaldırıp yeni bir ordu kurmak istedi.\nYeniçeriler ayaklanıp onu öldürdü (1622): isyanla öldürülen ilk padişah.',
      ),
      kart(
        'Abaza Mehmet Paşa',
        'Erzurum valisiydi; Genç Osman’ın öldürülmesini bahane ederek ayaklandı.\nEyalet isyanlarının bilinen örneğidir.',
      ),
      kart(
        'Çınar Vakası (1656)',
        'Maaşları değersiz akçeyle ödenen askerler ayaklandı.\nDevlet adamlarını Sultanahmet’teki çınar ağacına astılar; ardından Köprülü dönemi başladı.',
      ),
    ], [
      ...
      soru('II. Osman isyanla öldürülen ilk Osmanlı padişahıdır.', true, '1622.'),
      soru('Abaza Mehmet Paşa isyanı bir İstanbul isyanıdır.', false, 'Erzurum valisiydi; eyalet isyanı.'),
      soru('Çınar Vakası\'nın sebeplerinden biri maaşın değersiz akçeyle ödenmesidir.', true, 'Para bozulmuştu.'),
      sikli('Celali isyanlarını sert yöntemlerle bastıran?', ['Köprülü Mehmet Paşa', 'Kuyucu Murat Paşa'], 1, 'Köprülü sonra geldi.'),
      sikli('Genç Osman neyi amaçladığı için öldürüldü?', ['Yeni bir ordu kurmayı', 'Başkenti taşımayı'], 0, 'Yeniçeriyi kaldırmak istiyordu.'),
    ], [
      {
      ...
      {
        soru: 'Erzurum valisiyken ayaklanan paşa?',
        siklar: ['Kuyucu Murat', 'Abaza Mehmet'],
        dogru: 1,
        aciklama: {
          dogru: 'Abaza Mehmet Paşa eyalet isyanlarının örneğidir.',
          yanlis: 'Kuyucu Murat Paşa isyanları bastıran sadrazamdı. Ayaklanan Abaza Mehmet.',
        },
        kart: 10,
      },
    ]),
    konu('trh10-bilim-kultur', '1453-1683 Arasında Bilim, Kültür ve Sanat', [
      ...
      kart(
        'Evliya Çelebi',
        'Seyahatname’de on ciltte Osmanlı ülkesini ve komşularını anlattı.\nŞehirler, gelenekler ve diller için eşsiz bir kaynaktır.',
      ),
      kart(
        'Matrakçı Nasuh',
        'Şehirleri kuşbakışı çizdiği minyatürlerle tanınır.\nMatematikçi ve silahşordu; matrak oyununun mucidi sayılır.',
      ),
      kart(
        'Topkapı Sarayı',
        'Fatih döneminde yapıldı; yaklaşık dört yüzyıl devletin yönetim merkezi oldu.\nEnderun ve Divan-ı Hümayun buradaydı.',
      ),
      kart(
        'Hat ve tezhip',
        '- **Hat:** güzel yazı sanatı; Şeyh Hamdullah öne çıkar.\n- **Tezhip:** kitapların altın ve boyayla süslenmesi',
      ),
    ], [
      ...
      soru('Seyahatname Evliya Çelebi\'nin eseridir.', true, 'On cilt.'),
      soru('Topkapı Sarayı Kanuni döneminde yapıldı.', false, 'Fatih döneminde yapıldı.'),
      soru('Matrakçı Nasuh şehirleri kuşbakışı minyatürlerle çizdi.', true, 'Aynı zamanda matematikçiydi.'),
      sikli('Güzel yazı sanatı?', ['Tezhip', 'Hat'], 1, 'Tezhip süsleme.'),
    ], [
      {
      ...
      {
        soru: 'Şehirleri kuşbakışı minyatürlerle çizen sanatçı?',
        siklar: ['Evliya Çelebi', 'Matrakçı Nasuh'],
        dogru: 1,
        aciklama: {
          dogru: 'Matrakçı Nasuh sefer yolundaki şehirleri minyatürle çizdi.',
          yanlis: 'Evliya Çelebi gezdiği yerleri yazıyla anlattı. Minyatürler Matrakçı Nasuh\'un.',
        },
        kart: 10,
      },
    ]),
