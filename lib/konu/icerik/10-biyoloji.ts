...
export const biyoloji10 = program('biyoloji', 10, 'Enerjiden ekosisteme', [
  tema('byl10-t1', 'Enerji', [
    konu('byl10-enerji-onem', 'Canlılık İçin Enerjinin Önemi', [
      ...
      sikli('Kloroplastta ışıkla ATP üretimi?', ['Oksidatif fosforilasyon', 'Fotofosforilasyon'], 1, 'Oksidatif mitokondride.'),
    ...
    konu('byl10-fotosentez', 'Işık Enerjisiyle Besin Sentezi: Fotosentez', [
      ...
      sikli('Fotosentezde glikozun oksijeni nereden gelir?', ['CO₂\'den', 'Sudan'], 0, 'Suyun oksijeni O₂ gazı olarak çıkar; glikozunki CO₂\'den.'),
      ...
      sikli('Işıkla ATP ve NADPH üretimi nerede?', ['Stroma', 'Tilakoit zarları'], 1, 'Stroma glikoz sentezinin yeri.'),
    ], [
      {
    ...
    konu('byl10-kemosentez', 'Işık Kullanılmadan Besin Sentezi: Kemosentez', [
      ...
      sikli('Kemosentezle üretilen besinin karbonu nereden gelir?', ['Glikojen', 'CO₂'], 1, 'Fotosentezdeki gibi CO₂ bağlanır.'),
    ], [
      {
    ...
    konu('byl10-sindirim', 'Sindirim', [
      ...
      sikli('Hücre içi sindirimi yapan organel?', ['Ribozom', 'Lizozom'], 1, 'Ribozom protein sentezler.'),
    ], [
      {
    ...
    konu('byl10-sindirim-yapi', 'Canlılarda Sindirim Yapıları', [
      ...
      sikli('Otçulların öne çıkan dişi?', ['Sivri köpek dişleri', 'Geniş azı dişleri'], 1, 'Bitkiyi öğütmek için.'),
    ], [
      {
    ...
    konu('byl10-insan-sindirim', 'İnsanda Sindirim', [
      ...
      sikli('Tripsin nerede çalışır?', ['Midede', 'İnce bağırsakta'], 1, 'Midede protein sindiren enzim pepsin.'),
      sikli('Yağın kimyasal sindirimi nerede başlar?', ['Ağızda', 'İnce bağırsakta'], 1, 'Lipaz ve safra ince bağırsakta.'),
      sikli('Kalın bağırsaktaki bakteri florası ne üretir?', ['Bazı vitaminleri', 'Safrayı'], 0, 'Safra karaciğerde üretilir.'),
    ...
    konu('byl10-emilim', 'Emilim ve Taşınma', [
      ...
      sikli('K vitaminini üreten?', ['Mide öz suyu', 'Kalın bağırsak bakterileri'], 1, 'Yararlı bakteriler.'),
    ...
    konu('byl10-solunum', 'Hücresel Solunum', [
      ...
      sikli('Oksijenli solunumun son ürünleri?', ['Glikoz ve O₂', 'CO₂ ve su'], 1, 'Glikoz ve O₂ solunumun girenleri.'),
      sikli('Sitrik asit döngüsü nerede olur?', ['Mitokondri matriksinde', 'İç zarda'], 0, 'CO₂ burada ayrılır.'),
      sikli('Mitokondri iç zarında hangi evre geçer?', ['Elektron taşıma', 'Glikoliz'], 0, 'Glikoliz sitoplazmada, sitrik asit döngüsü matrikste.'),
      ...
      sikli('Oksijenli solunumun son ürünleri?', ['Etil alkol ve CO₂', 'CO₂ ve H₂O'], 1, 'Etil alkol fermantasyonun ürünü.'),
    ], [
      {
    ...
    konu('byl10-katilma', 'Besinlerin Solunuma Katılma Yolları', [
      ...
      soru('Açlıkta vücut önce glikojen depolarını kullanır.', true, 'Glikojen yaklaşık bir gün yeter; sonra yağ, en son protein.'),
      ...
      sikli('Üre hangi organda üretilir?', ['Böbrek', 'Karaciğer'], 1, 'Böbrek üreyi atar.'),
    ], [
      {
    ...
    konu('byl10-fermantasyon', 'Fermantasyon', [
      ...
      sikli('Fermantasyonun net ATP kazancı?', ['36', '2'], 1, 'Yalnız glikolizden.'),
    ], [
      {
    ...
    konu('byl10-metabolizma', 'Enerji-Metabolizma İlişkisi', [
      ...
      sikli('Hareketsiz yatan biri enerji harcar mı?', ['Hayır', 'Evet, bazal metabolizma kadar'], 1, 'Kalp, solunum, beyin çalışır.'),
    ], [
      {
  ...
  tema('byl10-t2', 'Ekoloji', [
    konu('byl10-bilesen', 'Ekosistemin Bileşenleri', [
      ...
      sikli('Komünite ile cansız çevre birlikte ne oluşturur?', ['Ekosistem', 'Popülasyon'], 0, 'Popülasyon aynı türden bireyler.'),
      ...
      sikli('Algler ekosistemde hangi roldedir?', ['Ayrıştırıcı', 'Üretici'], 1, 'Fotosentez yapar.'),
    ], [
      {
    ...
    konu('byl10-etkilesim', 'Tür İçi ve Türler Arası Etkileşimler', [
      ...
      sikli('Av azalınca avcı popülasyonu ne olur?', ['Artar', 'Azalır'], 1, 'İki popülasyon birbirini izler.'),
      ...
      sikli('Penisilin küfünün bakterileri engellemesi?', ['Mutualizm', 'Antibiyoz'], 1, 'Salgıyla engelleme.'),
    ], [
      {
    ...
    konu('byl10-suksesyon', 'Süksesyon', [
      ...
      sikli('Kayayı parçalayıp ilk toprağı oluşturan?', ['Çam', 'Liken'], 1, 'Asit salgılar.'),
    ], [
      {
    ...
    konu('byl10-populasyon', 'Popülasyon Dinamikleri', [
      ...
      sikli('3 km²\'de 600 birey varsa yoğunluk?', ['1800 / km²', '200 / km²'], 1, '600 / 3.'),
    ], [
      {
    ...
    konu('byl10-madde-enerji', 'Ekosistemde Madde ve Enerji Akışı', [
      ...
      sikli('Besin zincirinde ayrıştırıcılar nereye bağlanır?', ['Her basamağa', 'Yalnızca üreticiye'], 0, 'Her basamaktaki ölü madde ayrıştırıcıya gider.'),
    ...
    konu('byl10-dongu', 'Madde Döngüleri', [
      ...
      sikli('Ölü maddeden amonyak oluşması?', ['Nitrifikasyon', 'Amonifikasyon'], 1, 'Nitrifikasyon amonyağı nitrata çevirir.'),
    ...
    konu('byl10-surdurulebilirlik', 'Ekolojik Sürdürülebilirliğin Önemi', [
      ...
      sikli('Sürdürülebilir kalkınma tanımı hangi raporla yaygınlaştı?', ['Montreal Protokolü', 'Brundtland Raporu'], 1, 'Montreal ozonla ilgili.'),
    ...
    konu('byl10-kisitlayan', 'Sürdürülebilirliği Kısıtlayan Durumlar', [
      ...
      sikli('Tür azaldıkça ekosistemin şoklara dayanma gücü?', ['Artar', 'Düşer'], 1, 'Çeşitlilik ekosistemi dayanıklı kılar.'),
      ...
      sikli('Balık stoklarını korumanın yolu?', ['Daha çok ağ', 'Av yasağı ve boy sınırı'], 1, 'Üreme fırsatı verilir.'),
    ...
    konu('byl10-saglanmasi', 'Ekolojik Sürdürülebilirliğin Sağlanması', [
      ...
      sikli('Hangisi ekolojik ayak izini küçültür?', ['Her yolculukta özel araç', 'Toplu taşıma'], 1, 'Aynı yolculukta kişi başına düşen enerji azalır.'),
      ...
      sikli('Nesli tehlikedeki türlerin ticaretini denetleyen?', ['Ramsar', 'CITES'], 1, 'Ramsar sulak alanlar.'),
