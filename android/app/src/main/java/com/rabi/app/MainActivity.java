...
public class MainActivity extends BridgeActivity {
    ...
    private void gorevTaniminiAyarla() {
        // Kart başlığının rengi marka moru: ikonun zeminiyle aynı ve açık/koyu
        // temada değişmiyor, yani kart her koşulda aynı görünüyor. Açılış
        // ekranının zemini (acilis_zemin) bilerek kullanılmıyor — o koyu bir
        // ekran rengi, bu ise markanın rengi.
        int renk = ContextCompat.getColor(this, R.color.marka_mor);
